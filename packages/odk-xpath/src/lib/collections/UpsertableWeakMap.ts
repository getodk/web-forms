// TODO: this behavior is (currently) identical to `UpsertableMap`, but with
// `WeakMap` as its base class. Especially if we ever want to evolve the
// functionality of these, it would almost certainly be better to have some
// sort of generalized mixin functionality for both base classes.
