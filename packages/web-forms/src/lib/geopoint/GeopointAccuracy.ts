...
/**
 * Expresses quality of a
 * {@link GeopointValueObject.accuracy | geopoint value's accuracy}, relative to specified {@link GeopointAccuracyThresholdOptions | thresholds}:
 *
