/**
 * Default accuracy in meters that can usually be reached by modern devices
 * given enough time.
 *
 * @todo This depends on the device's capabilities, connectivity, etc. Can we
 * detect those conditions? If so, should we vary the default accordingly?
 */
